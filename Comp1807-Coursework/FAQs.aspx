...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; How do I create a PrivateHire account ?</p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; What should I do if I forget my password ?</p>
        <p style="color: #000000; text-align: center; width: 1178px; height: 29px; font-size: small;">
            1. You can sign up an account via our official website.</p>
        <p style="color: #000000; text-align: center; width: 1178px; height: 29px;font-size: small;">
            2. Click&nbsp;<asp:HyperLink ID="HyperLinkSignUp0" runat="server" NavigateUrl="~/SignUp.aspx">Sign Up</asp:HyperLink>
&nbsp;tab on the top of website.</p>
        <p style="color: #000000; text-align: center; width: 1178px; height: 29px; font-size: small;">
            3. Insert with all required information.</p>
        <p style="color: #000000; text-align: center; width: 1178px; height: 29px; font-size: small;">
